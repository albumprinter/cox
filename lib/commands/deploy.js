...
module.exports = function(args){
    ...
    var command = function(moduleName, moduleRepo, done){
        ...
        function updatePackage( version ){
            ...
            if(repo)
            {
                ...
                if(packageData[ "version" ] !== version || packageChanged)
                {
                    //update version of the Project, i.e. diff or any of the sub modules has been updated.
    ...
    var updateProject = function(moduleName, moduleRepo, done){
        ...
        {
            console.log("DONE: package.json has not changed" );
        }
